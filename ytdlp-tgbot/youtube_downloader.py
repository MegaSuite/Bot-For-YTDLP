...
class YoutubeDownloader:
    ...
    def download(self, url: str, content_type: ContentType, download_format_name: "str | None", use_cookie: bool = False) -> DownloaderResult:
        ...
        options = YoutubeDlOptions(use_cookie=use_cookie)
